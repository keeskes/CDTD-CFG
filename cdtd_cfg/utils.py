...
class FastTensorDataLoader:
    ...
    """
    # I changed the data loader to also take in y_condition_1 and 2 in order to return the same batch as x_cat and x_cont
    ...
    def __next__(self):
        ...
        if self.indices is not None:
            ...
            batch["y_cond_1_batch"] = (
                # Selects label values for y_condition_1 and 2 corresponding to the current batch indices.
            ...
            # If not shuffled, we simply return the next batch (of size batch_size) directly for y_condition_1 and 2
            batch["y_cond_1_batch"] = (
        ...
        return batch # Returns tuple: (X_cat, X_cont, y_cond_1_batch, y_cond_2_batch)
